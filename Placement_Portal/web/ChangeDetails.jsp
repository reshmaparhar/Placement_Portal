...
input[type = text]{
  ...
  <nav class="vertical">
    ...
    <tr bgcolor="purple">
     <td align=“middle”><font color="white" >REQUEST CHANGE</font></td>

     </tr> 
    </table>
                    <br>
                    <div s>
                        <label><font color = "green">Enter the detail to be changed</font></label>&nbsp;&nbsp;&nbsp;&nbsp;
                        <div style=" padding: 14px 20px;margin: 8px 0;border: none;">
                        <select name="old">
				...
				<option value="dob">Gender   </option>
				 ...
				 <option value="cgpa">CGPA</option>
                        ...
                        <label><font color = "green">Input New Value</font></label>
                        <br>
