    ...
    <ul>
      ...
      <li>
       ...
       <div class="wrapper" style="margin:30px">
		...
		<img src = "admin.jpg" width="1000" height="600">
...
<div style="height:900 auto; font-size:30px ;float:left;padding-left:10px;width:100%;background-color:#FFFFDA;color:#8A0000;min-width:1038px;">
